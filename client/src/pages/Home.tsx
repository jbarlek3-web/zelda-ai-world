...
export default function Home() {
  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-[#06130f] text-[#f7e9c2]">
      <GameCanvas className="absolute inset-0 h-full w-full touch-none" onStatus={setStatus} />
      <div className="pointer-events-none relative z-10 flex min-h-screen flex-col justify-between p-5 sm:p-8 lg:p-12">
        ...
        <section className="ml-auto max-w-sm rounded-sm border border-[#d9b867]/40 bg-[#08251e]/85 px-5 py-4 text-right shadow-[0_14px_55px_rgba(0,0,0,0.36)] backdrop-blur-sm">
          ...
          <p className="mt-1 text-xs uppercase tracking-[0.18em] text-[#d9b867]">WASD / arrows to travel · E to interact</p>
        </section>
      </div>
    </main>
  );
